...
Instead of only solving the problem mathematically, I also focused on modeling how such a computation would work in a distributed environment.
...
- Use of list comprehensions and user-defined functions
- Conceptual MapReduce modeling (Mapper & Reducer phases)
- Verification of results across different approaches
